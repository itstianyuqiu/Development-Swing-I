package ictgradschool.industry.lab11.examples.example7;
...
public class E7ShapeTriangle extends E7Shape {
	...
	public Polygon getPoints() {
		...
		// half DIM length
		int height = this.size * (int)Math.sqrt(Math.pow(E7Shape.DIM, 2) - Math.pow((E7Shape.DIM / 2), 2));
		...
		int apothem = this.size * (int)(E7Shape.DIM / (2 * Math.sqrt(3)));
